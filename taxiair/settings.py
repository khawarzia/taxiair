"""
Django settings for taxiair project.
...
SECRET_KEY = 'd$m5lokrjoj$=se5al%+cs#)%vs3frr7m5@j9!xyf7c(o+#u9i'
...
WSGI_APPLICATION = 'taxiair.wsgi.application'
